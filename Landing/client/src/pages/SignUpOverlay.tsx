    ...
    <div className="bg-white border border-solid border-black w-full min-w-[1198px] min-h-[852px] flex items-center justify-center">
      <form onSubmit={handleSubmit} className="flex flex-col items-center gap-8 w-full max-w-[797px] px-8">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-[459px] h-[63px] bg-[#d9d9d9] rounded-[64px] hover:bg-[#c9c9c9] h-auto"
        >
        ...
        <button
          type="button"
          onClick={() => setLocation("/")}
          className="[font-family:'Akira_Expanded-SuperBold',Helvetica] font-bold text-black text-[67.8px] tracking-[0] leading-[normal] whitespace-nowrap mt-8 bg-transparent border-0 cursor-pointer"
        >
          Have account? LOG IN
        </button>
        ...
        <button
          type="button"
          onClick={() => setLocation("/")}
          className="[font-family:'Akira_Expanded-SuperBold',Helvetica] font-bold text-black text-[48.4px] tracking-[0] leading-[normal] whitespace-nowrap mt-4 bg-transparent border-0 cursor-pointer"
        >
          BACK
        </button>
      </form>
